---
title: "Cerebrovascular Hypothsis Testing"
...
### 1. Race
```{r}
file_path <- here("Hypothesis test",  "data in excel", "Cerebrovascular", "Cerebrovascular by 6 Race.xlsx")
Cerebrovascular_by_6_Race <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_6_Race
...
```{r}
file_path <- here("Hypothesis test",  "data in excel", "Cerebrovascular", "Cerebrovascular by Urbanization.xlsx")
Cerebrovascular_by_Urbanization <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Urbanization
...
### 3. Education
```{r}
file_path <- here("Hypothesis test",  "data in excel", "Cerebrovascular", "Cerebrovascular by Education.xlsx")
Cerebrovascular_by_Education <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Education
...
```{r}
file_path <- here("Hypothesis test", "data in excel", "Cerebrovascular", "Cerebrovascular by Ten_Year_Age_Group.xlsx")
Cerebrovascular_by_Ten_Year_Age_Group <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Ten_Year_Age_Group
...
### 5. sex
```{r}
file_path <- here("Hypothesis test", "data in excel", "Cerebrovascular", "Cerebrovascular by Sex.xlsx")
Cerebrovascular_by_Sex <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Sex
...
### 6. reigon
```{r}
file_path <- here("Hypothesis test", "data in excel", "Cerebrovascular", "Cerebrovascular by Region.xlsx")
Cerebrovascular_by_Region <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Region
...
### 7. month
```{r}
file_path <- here("Hypothesis test", "data in excel", "Cerebrovascular", "Cerebrovascular by Month.xlsx")
Cerebrovascular_by_Month <- read_excel(file_path)
```

```{r}
df <- Cerebrovascular_by_Month
