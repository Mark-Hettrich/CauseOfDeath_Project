...
library(knitr)
knitr::opts_knit$set(root.dir = "C:/Users/Windows/Desktop/CauseOfDeath_Project")
```
...
### 1. Race
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by 6 Race.xlsx")
...
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Urbanization.xlsx")
...
### 3. Education
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Education.xlsx")
...
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Ten_Year_Age_Group.xlsx")
...
### 5. sex
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Sex.xlsx")
...
### 6. reigon
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Region.xlsx")
...
### 7. month
```{r}
file_path <- here("data in excel", "Cerebrovascular", "Cerebrovascular by Month.xlsx")
