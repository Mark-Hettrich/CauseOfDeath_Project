...
### 1. Race
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by 6 Race.xlsx")
Neoplasms_by_6_Race <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_6_Race
...
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Urbanization.xlsx")
Neoplasms_by_Urbanization <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_Urbanization
...
### 3. Education
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Education.xlsx")
Neoplasms_by_Education <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_Education
...
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Ten_Year_Age_Group.xlsx")
Neoplasms_by_Ten_Year_Age_Group <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_Ten_Year_Age_Group
...
### 5. sex
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Sex.xlsx")
Neoplasms_by_Sex <- read_excel(file_path) 
```
...
### 6. reigon
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Region.xlsx")
Neoplasms_by_Region <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_Region
...
### 7. month
```{r}
file_path <- here("data in excel", "Neoplasms", "Neoplasms by Month.xlsx")
Neoplasms_by_Month <- read_excel(file_path) 
```

```{r}
df <- Neoplasms_by_Month
