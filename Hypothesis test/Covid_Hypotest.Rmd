...
### 1. Race
```{r}
file_path <- here("data in excel", "Covid", "Covid by 6 Race.xlsx")
...
```{r}
file_path <- here("data in excel", "Covid", "Covid by Urbanization.xlsx")
...
### 3. Education
```{r}
file_path <- here("data in excel", "Covid", "Covid by Education.xlsx")
...
```{r}
file_path <- here("data in excel", "Covid", "Covid by Ten_Year_Age_Group.xlsx")
...
### 5. sex
```{r}
file_path <- here("data in excel", "Covid", "Covid by Sex.xlsx")
...
### 6. reigon
```{r}
file_path <- here("data in excel", "Covid", "Covid by Region.xlsx")
...
### 7. month
```{r}
file_path <- here("data in excel", "Covid", "Covid by Month.xlsx")
