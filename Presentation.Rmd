...
- Model Ideas and early implementation  --> Methodology & (maybe some early results)
...
$$
- The covariates we want to control for are (amonst others) age, region, gender, seasonality
