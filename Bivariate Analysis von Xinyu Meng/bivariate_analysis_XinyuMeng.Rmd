...
```{r}
# read data
male_data <- read.csv("15 causes of death_Male.csv")
female_data <- read.csv("15 causes of death_Female.csv")
...
#read data
children_data <- read.csv("15 causes of death_Children.csv")
young_adults_data <- read.csv("15 causes of deatha__Young_Adults.csv")
adults_data <- read.csv("15 causes of death_Adults.csv")
old_age_data <- read.csv("15 causes of death_Old_Age.csv")
...
college_higher <- read.csv("15 causes of death_College_Higher.csv", stringsAsFactors = FALSE)
high_school <- read.csv("15 causes of death_high school.csv", stringsAsFactors = FALSE)
under_12_grade <- read.csv("15 causes of death_under 12 grade.csv", stringsAsFactors = FALSE)
