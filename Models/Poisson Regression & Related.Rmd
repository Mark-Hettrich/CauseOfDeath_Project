...
```
!!!! this does not tell us, how does education affect wheather you die? But tells us: How does Education affect what you die of?  Whats the most likely cause of death?
```{r Multinomial Model}
