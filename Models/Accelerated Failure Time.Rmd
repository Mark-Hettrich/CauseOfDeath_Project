...
```{r Model summary}
emmeans(aft_weibull2, ~ Education * Cause, type = "response")  #only look at coefficients to check acceleration/deceleration!
emmeans(aft_weibull2, ~ Education * Cause | Sex, type = "response") #only look at coefficients to check acceleration/deceleration!
