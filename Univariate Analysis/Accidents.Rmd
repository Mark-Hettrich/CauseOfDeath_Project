Variables controlled for Accidents (unintentional injuries) (V01-X59,Y85-Y86) Death
...
Year
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Year", "Accidents_by_Year.csv")
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = Deaths)) +
  ...
  labs(title = "Accident Deaths per Year",
       x = "Year",
       y = "Number of Deaths") +
  theme_minimal()
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = (Deaths / Population) * 100000)) +
  ...
  labs(title = "Accident Death Rate per 100,000 Population",
       x = "Year",
...
Year & Month
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Year & Month", "Accidents_by_Year&Month.csv")
...
ym_df %>%
  ...
  labs(title = "Accident Deaths per Month (Jan-Dec)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
ym_df %>%
  ...
  geom_point(color = "red", size = 2) +
  geom_smooth() +
  labs(title = "Accident Deaths per Month (Jan 2018 - Dec 2023)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
10 Year Age Groups
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Ten Year Age Groups", "Accidents_by_AgeGroup10.csv")
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Age Group",
       x = "Age Group",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by Age Group (per 100,000 Population)",
       x = "Age Group",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Sex
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Sex", "Accidents_by_Sex.csv")
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Sex",
       x = "Sex",
       y = "Number of Deaths") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by Sex (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by Sex, Age adjusted (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
Race
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Race", "Accidents_by_Race.csv")
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Race",
       x = "Race",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by Race (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by Race Age adjusted (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Education
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Education", "Accidents_by_Education.csv")
...
education_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Education Attainment Level",
...
Urbanization
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "Urbanization", "Accidents_by_Urbanization.csv")
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Urbanization",
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by Urbanization Level, normalized",
       x = "Urbanization levels",
...
State
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Accidents", "State", "Accidents_by_State.csv")
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Deaths by State",
       x = "State",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by State (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Accident Death Rate by State Age adjusted (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
