Variables controlled for all Deaths:
...
year_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by Year, Age adjusted (per 100,000 Population)",
       x = "Year",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
ym_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths per Month (Jan-Dec)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths by Sex",
       x = "Sex",
       y = "Number of Deaths") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by Sex (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
...
Race
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Totals", "Race", "Totals_by_Race.csv")
...
total_d <- race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths by Race",
       x = "Race",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
normalized_d <- race_df %>%
  filter(!is.na(`Single Race 6`)) %>%
  ggplot(aes(x = `Single Race 6`, y = (Deaths / Population) * 100000)) +
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by Race (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by Race Age adjusted (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Education
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Totals", "Education", "Totals_by_Education.csv")
...
sum(education_df$Deaths[1:4])/0.484 - sum(education_df$Deaths[5:8])/0.516
...
educ_filtered <- education_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths by Education Attainment Level",
       x = "Education Attainment Level",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_blank())

educ_unfiltered <- education_df %>%
  mutate(Education = factor(Education, levels = education_order)) %>%
  ggplot(aes(x = Education, y = Deaths, fill = Education)) +
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths by Education Attainment Level",
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Deaths by Urbanization",
...
State
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Totals", "State", "Totals_by_State.csv")
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by State (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  scale_fill_manual(values = c("Republican" = "red", "Democratic" = "blue")) + 
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Total Death Rate by State Age adjusted (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  scale_fill_manual(values = c("Republican" = "red", "Democratic" = "blue")) +
