Variables controlled for Malignant Neoplasms (C00-C97) Deaths:
...
Year
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Year", "COVID_by_Year.csv")
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = Deaths)) +
  ...
  labs(title = "COVID Deaths per Year",
       x = "Year",
       y = "Number of Deaths") +
  theme_minimal()
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = (Deaths / Population) * 100000)) +
  ...
  labs(title = "COVID Death Rate per 100,000 Population",
       x = "Year",
...
year_df %>%
  ...
  labs(title = "COVID Death Rate by Year, Age adjusted (per 100,000 Population)",
       x = "Year",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
Year & Month
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Year & Month", "COVID_by_Year&Month.csv")
...
ym_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths per Month (Jan-Dec)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
ym_df %>%
  ...
  geom_point(color = "red", size = 2) +
  geom_smooth() +
  labs(title = "COVID Deaths per Month (Jan 2018 - Dec 2023)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
10 Year Age Groups
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Ten Year Age Groups", "COVID_by_AgeGroup10.csv")
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Age Group",
       x = "Age Group",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by Age Group (per 100,000 Population)",
       x = "Age Group",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Sex
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Sex", "COVID_by_Sex.csv")
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Sex",
       x = "Sex",
       y = "Number of Deaths") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by Sex (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by Sex, Age adjusted (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
Race
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Race", "COVID_by_Race.csv")
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Race",
       x = "Race",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by Race (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by Race Age adjusted (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Education
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Education", "COVID_by_Education.csv")
...
education_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Education Attainment Level",
...
Urbanization
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "Urbanization", "COVID_by_Urbanization.csv")
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Urbanization",
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Deaths by Urbanization Level, normalized",
       x = "Urbanization levels",
...
State
```{r}
file_path <- here("Datasets", "Univariate Analysis", "COVID", "State", "COVID_by_State.csv")
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by State (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  scale_fill_manual(values = c("Republican" = "red", "Democratic" = "blue")) + 
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "COVID Death Rate by State Age adjusted (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  scale_fill_manual(values = c("Republican" = "red", "Democratic" = "blue")) +
