...
Year
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Year", "Neoplasms_by_Year.csv")
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = Deaths)) +
  ...
  labs(title = "Neoplasm Deaths per Year",
       x = "Year",
       y = "Number of Deaths") +
  theme_minimal()
...
ggplot(year_df %>% filter(!is.na(Year)), aes(x = Year, y = (Deaths / Population) * 100000)) +
  ...
  labs(title = "Neoplasm Death Rate per 100,000 Population",
       x = "Year",
...
year_df %>%
  ...
  labs(title = "Neoplasm Death Rate by Year, Age adjusted (per 100,000 Population)",
       x = "Year",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
Year & Month
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Year & Month", "Neoplasms_by_Year&Month.csv")
...
ym_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasms Deaths per Month (Jan-Dec)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
ym_df %>%
  ...
  geom_point(color = "red", size = 2) +
  geom_smooth() +
  labs(title = "Neoplasms Deaths per Month (Jan 2018 - Dec 2023)",
       x = "Month",
       y = "Number of Deaths") +
  theme_minimal() +
...
10 Year Age Groups
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Ten Year Age Groups", "Neoplasms_by_AgeGroup10.csv")
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Age Group",
       x = "Age Group",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
age_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by Age Group (per 100,000 Population)",
       x = "Age Group",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Sex
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Sex", "Neoplasms_by_Sex.csv")
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Sex",
       x = "Sex",
       y = "Number of Deaths") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by Sex (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
...
sex_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by Sex, Age adjusted (per 100,000 Population)",
       x = "Sex",
       y = "Death Rate per 100,000") +
  theme_minimal()
```
...
Race
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Race", "Neoplasms_by_Race.csv")
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Race",
       x = "Race",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by Race (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
race_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by Race Age adjusted (per 100,000 Population)",
       x = "Race",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
Education
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Education", "Neoplasms_by_Education.csv")
...
education_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Education Attainment Level",
...
Urbanization
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "Urbanization", "Neoplasms_by_Urbanization.csv")
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Urbanization",
...
urbanization_data %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by Urbanization Level, normalized",
       x = "Urbanization levels",
...
State
```{r}
file_path <- here("Datasets", "Univariate Analysis", "Neoplasms", "State", "Neoplasms_by_State.csv")
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Deaths by State",
       x = "State",
       y = "Number of Deaths") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
state_df %>%
  ...
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by State (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
state_df %>%
  filter(!is.na(State)) %>%
  ggplot(aes(x = State, y = `Age Adjusted Rate`)) +
  geom_bar(stat = "identity") +
  labs(title = "Neoplasm Death Rate by State Age adjusted (per 100,000 Population)",
       x = "State",
       y = "Death Rate per 100,000") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
